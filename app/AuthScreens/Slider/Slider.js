...
export default class Slider extends React.Component {
    ...
    bookserviceClick = () => {
        handleNavigation({type:'push',page:'Slider1',navigation:this.props.navigation})
    }
                ...
                <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps={'handled'} contentContainerStyle={{ paddingBottom: 22 }}>
                    ...
                    <View style={{ alignItems: 'center', marginTop: '15%' }}>
                        <Text style={{
                            ...
                            fontFamily: fonts.PoppinsExtraBold, fontWeight: 'bold'
                    ...
                    <View style={{ alignItems: 'center', marginVertical: 5, }}>
                        <View style={{ width: 200, justifyContent: 'center' }}>
                            <Text style={{ textAlign: 'center', fontSize: fonts.fontSize14, color: Colors.black, fontFamily: fonts.RoBoToMedium_1 }}>Work through a progressive gym based programme</Text>
                        </View>
                    ...
                    <View style={{ alignItems: 'center', marginTop: '20%', justifyContent: 'center' }}>
                        ...
                        onPress={() => { this.bookserviceClick() }}
                         style={{backgroundColor:Colors.black,paddingHorizontal:50,
